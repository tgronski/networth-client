      ...
      <div id="Advice" className="Resources">
        {length === 0 ? (
          <div>
            ...
            <i>
              Submit your most recent networth data to get the most accurate
              information
            </i>
          </div>
        ) : null}
        {updatednetworth.networth_total_value < 0 ? (
          <ul className="list" id="debtList">
            ...
            <h2>Financial Planning Resources:</h2>
            <li key={debts.id}>
              We see that you are working on paying off some debt, great work!
              You may want to check out <br /> money saving sites like:{" "}
              {debts.content}
            </li>
            <br />
          </ul>
        ...
        {updatednetworth.networth_total_value >= 0 ? (
          <ul className="list" id="assetList">
            ...
            <h2>Financial Planning Resources:</h2>
            <li key={assets.id}>
              We see that you are saving money, which is great! You may want to
              consider <br />
              an investment account like {assets.content} to continue saving.{" "}
            </li>
            <br />
          </ul>
        ) : null}
